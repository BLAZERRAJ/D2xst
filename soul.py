...
TOKEN = '7285597362:AAHE_9OymfgN7qREuFpI0i3a0XwsLsXOlqo'
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*D2X SERVER HACK STARTED\nAttack started 💥\n\nHost: {target_ip}\nPort: {target_port}\nTime: {duration}*", parse_mode='Markdown')
    except Exception as e:
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.m/10599*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@Blazeraj @D2X_OWNER*", parse_mode='Markdown')
    else:
